...
<body>
    ...
    <div class="all-content-wrapper">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <div class="add-product">
                                ...
                                @endif
                                <form id="acteDecesForm" action="{{route('demande.ActeDeces')}}" method="POST" style="background-color: white;">
      <div>
      <h1 style="color:blue;">Formulaire Acte de décès    </h1>

        @csrf
        <label for="numero_registre">Numéro du registre :</label><br>
        <input type="text" id="numero_registre" class="form-control" name="numero_registre" >
      </div><br>

      <div>
        <label for="centre">Centre :</label><br>
        <input type="text" id="centre" name="centre"  class="form-control">
      </div><br>

      <div>
        <label for="date_deces">Date du décès :</label><br>
        <input type="date" id="date_deces" name="date_deces"  class="form-control" >
      </div><br>

      <div>
        <label for="lieu_deces">Lieu du décès :</label><br>
        <input type="text" id="lieu_deces" name="lieu_deces"   class="form-control">
      </div><br>
      ...
      <input type="hidden" id="nom_mere" name="id"  value="{{$users[0]->id}}"><br>
