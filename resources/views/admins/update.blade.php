                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="sparkline12-list mg-t-30 responsive-mg-b-0">
                            ...
                            <form action="{{route('update.informations')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                            <div class="sparkline10-graph">
                                <div id="pwd-container3">
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input type="text" class="form-control" id="username" name="nom" value="{{Auth::user()->name}}" placeholder="Username">
                                    </div>
                                    <div class="form-group">
                                        <label for="username">Prenom</label>
                                        <input type="text" class="form-control" id="username" name="prenom" value="{{Auth::user()->prenom}}" placeholder="Prenom">
                                    </div>
                                    <div class="form-group">
                                        <label for="password3">email</label>
                                        <input type="email" class="form-control example3" id="password3" name="email" value="{{Auth::user()->email}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="password3">Tel</label>
                                        <input type="text" class="form-control example3" id="password3" name="tel" value="{{Auth::user()->tel}}">
                                    </div>
                                    <div class="form-group">
